...
handlers._tokens.put = function(data,callback){
    ...
    // *   Optional Data: phone
    // */
    // var id = typeof(data.query.id) == 'string' && data.query.id.trim() == 20 ? data.query.id.trim() : false;
    // var phone = typeof(data.query.phone) == 'string' && data.query.phone.trim() == 10 ? data.query.phone.trim() : false;
