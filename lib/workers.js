...
workers.processCheckOutcome = function(originalCheckData, checkOutcome){
    ...
    // TEST: Log the outcome of the Check
    var timeOfCheck = Date.now();

    // Call worker.log() to log the data to workers log files
    workers.log(originalCheckData, timeOfCheck, checkOutcome, state, alertWarranted);
...
workers.log = function(originalCheckData, timeOfCheck, checkOutcome, state, alertWarranted){
    // Form the log data
    var logDataObj = {
    ...
    var logString = JSON.stringify(logDataObj);

    // Determine the name of log file
    var logFileName = originalCheckData.id;

    // Append the log string to the file we want to
